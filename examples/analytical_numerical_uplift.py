...
print("Analytical solution is for no uplift.")
print("Numerical solution is for uplift at", 1000*lp.U*3.15E7, "mm/yr") 
...
ax1.plot(lp.x/1000., lp.z, '0.7', linewidth=6,
    label='Numerical: Uplift at '+str(1000*lp.U*3.15E7)+' mm/yr')
ax1.plot(lp.x/1000., lp.zanalytical, '0.3', linewidth=2,
    label='Analytical: no uplift')
#ax1.set_ylim((0, 400))
