...
plotdir = 'DoublePrecip_movie_frames'
...
# NO CHANGE WITHOUT THIS LINE
net.update_z_ext_external_upstream( S0 = 0.015 * .5**(7/6.) )  # b.c.


# Try just one
# So double Q in all, but Qs increases with Q in all but trib 0.
net.update_z_ext_external_upstream( S0 = [0.015 * .5**(7/6.), 0.015, 0.015] )  # b.c.
