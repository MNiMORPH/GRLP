...
Qlist = [10., 20., 30., 40.]
upstream_segment_list = [[], [], [0,1], [2]]
downstream_segment_list = [[2], [2], [3], []]
...
segments[2].z += segments[3].z_ext[0] - 7.5 # BAND-AID
segments[2].z_ext += segments[3].z_ext[0] - 7.5 # BAND-AID
segments[1].z += segments[2].z_ext[0] - 7.5 # BAND-AID
segments[1].z_ext += segments[2].z_ext[0] - 7.5 # BAND-AID
segments[0].z += segments[2].z_ext[0] - 7.5 # BAND-AID
segments[0].z_ext += segments[2].z_ext[0] - 7.5 # BAND-AID
...
plt.xlim(-6500,3500)
plt.tight_layout()
plt.text(-3000, 150, "Start.", fontsize=26, fontweight='bold')
plt.draw()
