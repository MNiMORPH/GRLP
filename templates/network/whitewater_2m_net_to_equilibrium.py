...
###############################################
# NORMAL SIZE, EXTRACTED AND SMOOTHED PROFILE #
###############################################
...
ax.invert_xaxis()
plt.tight_layout()
plt.savefig('Whitewater_sand_network_modern.svg')
plt.close('all')
...
ax.invert_xaxis()
plt.tight_layout()
plt.savefig('Evolution_10000yr.svg')
#plt.savefig('Evolution_10000yr_double_size.svg')
plt.show()
